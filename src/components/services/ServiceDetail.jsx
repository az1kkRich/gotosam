...
import { CalendarIcon as CalendarArrowUp, Minus, Plus, SendHorizontal } from "lucide-react"
          ...
          <div className="max-w-[90rem] mx-auto flex flex-row items-center mt-4 px-4">
            <div className="w-full flex flex-col xl:flex-row rounded-xl shadow bg-white ">
              ...
              <form
                ...
                className=" p-4 border w-full xl:w-1/2  flex flex-col md:flex-row items-start"
              >
